...
export const CommandMenu = ({ open, setOpen }) => {
  ...
  return (
    <Command.Dialog open={open}
     ...
     >
      <div className="bg-white rounded-lg shadow-xl border-stone-300 border overflow-hidden w-full
      max-w-lg mx-auto mt-12" onClick={(e)=>e.stopPropagation()}>
        <Command.Input
        value={value}
        ...
        <Command.Group heading="Team" className='text-sm mb-3 text-stone-400'>
          <Command.Item className='flex cursor-pointer transition-colors p-2 text-sm
           text-stone-950 hover:bg-stone-200 rounded items-center gap-2  '>
            <FiPlus />
            Invite Member</Command.Item>
          <Command.Item className='flex cursor-pointer transition-colors p-2 text-sm
           text-stone-950 hover:bg-stone-200 rounded items-center gap-2 '>
            <FiEye />
            See Org Chart</Command.Item>
          </Command.Group>
        <Command.Group heading="Integration" className='text-sm mb-3 text-stone-400'>
          <Command.Item className='flex cursor-pointer transition-colors p-2 text-sm
           text-stone-950 hover:bg-stone-200 rounded items-center gap-2  '>
            <FiLink />
            Link Services</Command.Item>
          <Command.Item className='flex cursor-pointer transition-colors p-2 text-sm
           text-stone-950 hover:bg-stone-200 rounded items-center gap-2 '>
            <FiPhone />
            Contact Support</Command.Item>
          </Command.Group>
          <Command.Item className='flex cursor-pointer transition-colors p-2 text-sm text-stone-50
